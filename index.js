...
/*
  ...
  The answer is actually quite simple.  While the external variable would not be able to access the internal variable, everything in JavaScript works from the inside out.  So, the nested function is the most inner part of 'myFunction', and therefore can access any of the variables that are outside of it.  When a function, method, or variable is accessing variables or the result of other functions or methods outside of it's own functional or block scopes, it creates that sort of a closure.
...
function USApop(zooAnimals) {
  const totalPopulation = zooAnimals.reduce((totalPop, animal) => {
